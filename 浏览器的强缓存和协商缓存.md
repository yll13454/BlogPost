[浏览器的强缓存和协商缓存](https://github.com/frontend9/fe9-interview/issues/29)
...
> [![image.png](media/57010212-249bda80-6c2e-11e9-8500-afe8c449e35f.png)](https://user-images.githubusercontent.com/11473889/57010212-249bda80-6c2e-11e9-8500-afe8c449e35f.png)
...
[![image.png](media/57010205-16e65500-6c2e-11e9-8334-ce884274e529.png)](https://user-images.githubusercontent.com/11473889/57010205-16e65500-6c2e-11e9-8334-ce884274e529.png)
...
2. `Nginx` 配置
   ...
   [![image.png](media/57010188-fae2b380-6c2d-11e9-974e-6d2cb4eee219.png)](https://user-images.githubusercontent.com/11473889/57010188-fae2b380-6c2d-11e9-974e-6d2cb4eee219.png)
...
1. 如果在 `cache-control `定义的 `max-age` 时间之内，`js`, `css` 文件会走强缓存，`http` 状态码是 200， 跟服务器也并不会有交互。但是第一个文件 `index.html` 文件, 每次回车或者刷新都是状态码都是 304 ，因为它的请求头中默认每次都携带了 `Cache-Control: max-age=0` 。
   ...
   [![image.png](media/57023165-e9b49980-6c63-11e9-9184-577bf610cc26.png)](https://user-images.githubusercontent.com/11473889/57023165-e9b49980-6c63-11e9-9184-577bf610cc26.png)

   [![image.png](media/57023171-ede0b700-6c63-11e9-9f3a-7ba52004e009.png)](https://user-images.githubusercontent.com/11473889/57023171-ede0b700-6c63-11e9-9f3a-7ba52004e009.png)

2. `js` `css` 文件 `cache-control `超时之后，重新按回车会走协商缓存，请求服务器发现资源没有改变，于是返回 304 ，浏览器从缓存中获取内容，从 `size` 中也可以看出端倪， 几百 B 的包不是静态资源的体积。

   [![image.png](media/57023233-0c46b280-6c64-11e9-9ab2-69d727432034.png)](https://user-images.githubusercontent.com/11473889/57023233-0c46b280-6c64-11e9-9ab2-69d727432034.png)
